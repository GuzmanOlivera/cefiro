...
class Paciente(Persona):
	...
	edad = fields.Integer('Edad') #Habría que relacionarlo con la fecha de nacimiento y hacerlo de sólo lectura
	...
	#	
	horarioPref = fields.Selection([('m',u'Mañana'),('t','Tarde'),('n','Noche')],'Horario de Preferencia')
